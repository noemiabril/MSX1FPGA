...
;	and	$40
	...
	ld	a, $0	;Mister VHD ; Ponemos un 0 = V1, Testing, si no funciona 1 =V2 y tambien en el ID del fabricante
	ld	(ix+15), a	; salva informacao da versao do SD (V1 ou V2) no byte 15 do CID ----- 0 = V1

;En Mister no es necesario el VHD no deja usar otro tamaño de sector
	call	mudarTamanhoBlocoPara512		; se bit CCS do OCR for 1, eh cartao SDV2 (Block address - SDHC ou SDXD)
