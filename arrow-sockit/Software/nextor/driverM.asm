...
DEV_STATUS:
	...
	jr	nz, .saicomerro
	;ld	(WRKAREA.NUMSD), a
    jp  .semMudanca ; Mister : Lo definiremos como no removible, el status siempre sera no changed
 IF HWDS = 0
	ld	a, (WRKAREA.FLAGS)
	and	1
	jr	z, .semMudanca
...
.NUMSD		db 1	; Currently selected card: 1 or 2
